...
export const heroData = {
  ...
  subtitle: "Accelerate new developer productivity with intelligent agents that understand your codebase and provide personalized guidance.",
  cta: "Try Demo",
...
export const portfolioData = {
  techStack: [
    "FastAPI", "Next.js", "TypeScript", "React", "Tailwind CSS",
    "ChromaDB", "SQLite", "Python", "AI/ML", "Vector Search"
  ],
  highlights: [
